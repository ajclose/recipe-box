...
Ingredient.create!(recipe_id: scrambled_eggs.id, name: "butter", quantity: "1", unit: "Tbsp")
Ingredient.create!(recipe_id: scrambled_eggs.id, name: "egg", quantity: "2")
Ingredient.create!(recipe_id: scrambled_eggs.id, name: "salt", quantity: "1", unit: "tsp")
Ingredient.create!(recipe_id: scrambled_eggs.id, name: "pepper", quantity: "1", unit: "tsp")
